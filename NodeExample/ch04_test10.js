...
var output = '안녕 1!';   // 문자열 선언
var buffer1 = new Buffer(10); // 길이 10짜리 버퍼 객체 생성 
var len = buffer1.write(output, 'utf8'); // write 하면서 문자 넣고 utf8 인코딩
console.log('첫번째 버퍼에 쓰인 문자열의 길이 : ' + len);
console.log('첫번째 버퍼의 문자열 : %s', buffer1.toString());


// 버퍼 객체를 문자열을 이용해 만듭니다.
var buffer2 = new Buffer('안녕 2!', 'utf8'); // '안녕 2!' 데이터가 들어간 버퍼 생성
console.log('두번째 버퍼의 길이 : %s', Buffer.byteLength(buffer2));
...
var byteLen = Buffer.byteLength(output);// byte 길이 확인
