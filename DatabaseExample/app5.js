...
function createUserSchema() {
	...
	UserSchema.method('encryptPassword', function(plainText, inSalt) {
		if (inSalt) {
            /* 암호화 결과 예시 'sha512' 사용 할것 sha1 보안문제 있음. 
            digest에는 어떤 인코딩 방식으로 암호화된 문자열을 표시할지를 정해줍니다. 
            base64, hex, latin1 등의 방식이 있는데 base64가 짧아서 더 선호됩니다.
            
            crypto.createHash('sha512').update('비밀번호').digest('base64'); 
// 암호화 결과 => 'dvfV6nyLRRt3NxKSlTHOkkEGgqW2HRtfu19Ou/psUXvwlebbXCboxIPmDYOFRIpqav2eUTBFuHaZri5x+usy1g=='
            crypto.createHash('sha512').update('비밀번호').digest('hex'); 
// 암호화 결과 => '76f7d5ea7c8b451b773712929531ce92410682a5b61d1b5fbb5f4ebbfa6c517bf095e6db5c26e8c483e60d8385448a6a6afd9e513045b87699ae2e71faeb32d6'
            */
